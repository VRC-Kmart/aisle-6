...
logInfo();
addAssociate("JamarFromAfar", "Sporting Goods");
addAssociate("Muffin of time", "Electronics");
addDepartment("Muffin of time", "Cast Enjoyer");
addAssociate("snackiedoodle", "KCafe");
addAssociate("Bakêd", "Electronics");
